        ...
        <section className="relative w-full h-[400px] overflow-hidden" aria-label="Video Background Section">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/40 flex items-center justify-center px-6 text-center">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-extrabold mb-4 leading-tight text-white"> Ready To Capture Your <br /> Brand Vision? </h2>
      ...
      <section  className="px-6 pt-8 flex flex-col justify-between max-w-[1350px] mx-auto w-11/12" aria-label="Footer Information">
         <div className="flex justify-between pb-[100px] footer">
          <address className="not-italic text-sm space-y-2 footer-last" itemScope itemType="http://schema.org/Organization">
            <h3 className=" font-bold footer-second-heading pb-4" itemProp="name">  The Freelancer_ </h3>
            <p className="text-base">
              <a href="mailto:thefreelancers27@gmail.com" className="text-gray-100 hover:underline" itemProp="email">
                thefreelancers27@gmail.com
              </a>
            </p>
            <p className="text-base">
              <a href="tel:+917004505998" className="text-gray-100 hover:underline" itemProp="telephone">
                (+91) 700 450 5998
              </a>
            </p>
          </address>
          ...
          {/* Social Media Icons */}
          <nav aria-label="Social Media" className="flex gap-5 pt-6 md:text-3xl ">
            {[
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-gray-200 gap-2 text-center">
